...
const ProductDetails = () => {
    ...
    const product = products.find((iitem)=>iitem._id === id);
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button onClick={()=>{addToCart(product._id);navigate("/cart")}} className="w-full py-3.5 cursor-pointer font-medium bg-primary-dull text-white hover:bg-indigo-600 transition" >
                            Buy now
                        </button>
                    </div>
                </div>
