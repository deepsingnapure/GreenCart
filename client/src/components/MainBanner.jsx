  ...
  return (
    <div className='relative'>
      ...
      <div className='flex items-center mt-6 font-medium'>
        <Link className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary text-white 
        hover:bg-primary-dull transition rounded-full text-sm cursor-pointer' to="/products">
            Shop Now
            <img className='md:hidden transition group-focus:transition-x-1'
        ...
        <Link className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer' to="/products">
            Explore deals
            <img className='transition group-hover:transition-x-1'
